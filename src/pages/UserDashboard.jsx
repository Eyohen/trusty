...
//               Support for MP3, WAV, M4A files up to 2GB
//             </p>
//             <input
//               type="file"
//               accept=".mp3,.wav,.m4a"
...
//               >
//                 {uploadProgress > 0 && uploadProgress < 100 ? 'Uploading...' : 'Upload & Continue to Pricing'}
//               </button>
//             </div>
//           )}
//         </div>
...
//                   <div>
//                     <h3 className="font-semibold text-gray-900">Meeting Recording {item}</h3>
//                     <p className="text-gray-600">45 minutes • 3 speakers</p>
//                   </div>
//                 </div>
//                 <div className="flex items-center space-x-4">
